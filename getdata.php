...
$stc=$_GET['stc'];
$stn=$_GET['stn'];
$url="http://trains.technoparkliving.com/arrivals.php?stc=".$stc.
"&stn=".$stn;
...
$data=array("data"=>array($final_north,$final_south));

echo json_encode($data);
//readfile("http://trains.technoparkliving.com?stc=KTYM&stn=Kottayam");
?>
